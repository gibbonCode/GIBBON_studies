...
switch modelOrderCase
    case {0,2} %crop the data to displacement ~ 0.25 mm
        disp_exp=disp_exp(1:end-15);
        load_exp=load_exp(1:end-15);
        displacementMagnitude=max(disp_exp);
end
...
plot(disp_exp_original,load_exp_original,'b.-','LineWidth',3);
...
if runFlag==1 %i.e. a succesful run
    ...
    hl(3)=plot(disp_exp_original,load_exp_original,'b-','lineWidth',lineWidth);
...
Hn(3)=plot(disp_exp_original,load_exp_original,'b-','lineWidth',lineWidth*1.1);
